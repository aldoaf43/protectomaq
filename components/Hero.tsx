...
export default function Hero({ data }: HeroProps) {
  ...
  return (
    <section className="relative md:pt-32 md:pb-20 flex flex-col lg:flex-row items-center md:px-32 p-6 pt-20  overflow-hidden mx-auto bg-grid">
      <div className="glow-spot top-[-10%] left-0" />
      <div className="glow-spot bottom-[-10%] right-0" />
        ...
        <div className="z-10 lg:w-3/5 text-center lg:text-left">
          {label && (
            ...
            >
              ...
              <span className="text-zinc-400 text-[8px] md:text-xs font-bold uppercase tracking-[0.3em]">
                {label}
              </span>
            </motion.div>
          )}
          ...
          {title && (
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-black leading-[0.9] mb-8 tracking-tighter text-gradient uppercase italic"
            >
              {title}
            </motion.h1>
          )}
